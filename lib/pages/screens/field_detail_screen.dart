...
class _FieldDetailScreenState extends State<FieldDetailScreen>
 ...
 void _showBookingDialog(Field field) {
  ...
  Future<void> _refreshFieldData() async {
    try {
      final updatedField = await _bookingService.getFieldDetails(currentField.id);
      setState(() {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          currentField.location ?? 'Ubicación no disponible',
                          style: TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                          ),
...
CarouselSlider(
  ...
  items: (widget.field.images ?? []).map((url) {
    ...
    final fullImageUrl = Uri.parse(baseUrl).replace(path: url).toString();
        ...
        errorWidget: (context, url, error) => Icon(Icons.error),
                ...
                Positioned(
                  ...
                  child: Row(
                    ...
                    children: (currentField.images ?? []).asMap().entries.map((entry) {
                      return Container(
                        width: 8,
                        height: 8,
                        ...
                        decoration: BoxDecoration(
                          ...
                          color: _currentImage == entry.key ? Colors.white : Colors.grey,
                        ),
                      );
                    }).toList(),
                  ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Table(
                                    ...
                                    children: currentField.available_hours.entries.map((entry) {
                                      return TableRow(
                                        children: [
                                          Padding(
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              ...
                                              style: TextStyle(height: 1.5, color: Colors.green, fontWeight: FontWeight.bold),
                                            ),
                                          ),
                                        ],
                                      );
